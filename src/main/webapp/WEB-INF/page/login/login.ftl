...
<title>浙大网新公共服务平台</title>

<link href="${website_static_resource_url}/resource/hplus/css/bootstrap.min.css" rel="stylesheet">
<link href="${website_static_resource_url}/resource/hplus/css/font-awesome.min.css" rel="stylesheet">
    
<style type="text/css">
body{
    background:url(${website_static_resource_url}/resource/hplus/img/loginDialog/background.jpg) no-repeat 0 0 scroll;
}
#text-title{
...
/*核心中间部分内容*/
#center_right{
 float:right;width:390px; height:400px; background:url(${website_static_resource_url}/resource/hplus/img/loginDialog/text_backbg.png) no-repeat;
...
<body>
	...
	<script src="${website_static_resource_url}/resource/hplus/js/jQuery/all/jquery.js"></script>
    <script src="${website_static_resource_url}/resource/hplus/js/bootstrap.min.js"></script>
    <script src="${website_static_resource_url}/resource/hplus/js/plugins/layer/layer.min.js"></script>
    <script src="${website_static_resource_url}/resource/hplus/js/rc.all-2.0.js"></script>
    <script src="${website_static_resource_url}/resource/hplus/js/RSA.js"></script>
</body>
